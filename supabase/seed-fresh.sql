-- =============================================================================
-- Netflix Portfolio v2 — FRESH Seed (Truncate + Re-seed)
-- Run this in the Supabase SQL editor to wipe and repopulate all data.
-- WARNING: This deletes ALL existing data before inserting.
-- =============================================================================
...
-- ─── CERTIFICATIONS ──────────────────────────────────────────────────────────
-- NOTE: Replace null verification_url values with your actual certificate URLs.
...
(
  ...
  'Stripe',
  '2025-04-01',
  null,  -- Replace with: https://www.credential.net/YOUR_CERT_ID
  1, true
),
(
  'AI Academy Level 3',
  'Ciklum',
  '2025-01-01',
  null,  -- Internal certification — no public URL
  2, true
),
(
  ...
  'Udemy',
  '2023-06-01',
  null,  -- Replace with: https://www.udemy.com/certificate/YOUR_CERT_ID/
  3, true
),
(
...
(
  ...
  'LinkedIn Learning',
  '2023-09-01',
  null,  -- Replace with your LinkedIn Learning certificate URL
  6, true
),
(
  ...
  'Coursera (Meta)',
  '2023-03-01',
  null,  -- Replace with: https://www.coursera.org/verify/YOUR_CERT_ID
  7, true
),
(
...
(
  ...
  'Codio',
  '2022-09-01',
  null,  -- Replace with your Codio certificate URL
  9, true
),
(
...
(
  ...
  'HackerRank',
  '2023-01-01',
  null,  -- Replace with: https://www.hackerrank.com/certificates/YOUR_CERT_ID
  11, true
),
(
